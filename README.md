...
<div align="center">
  <img src="Images/ERD.png" alt="Entity Relationship Diagram Djiwa Medical" width="1000">
  <br>
...
│   ├── 📄 apps.R               # Script utama untuk menjalankan (run) aplikasi
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="70%">
      ...
      <a href="mailto:ikalailia06@gmail.com" target="_blank">
        <img src="Images/icon_email.png" alt="Instagram" width="25">
      </a>
    </td>
  </tr>
...
<p align="center">
  ...
  <style>
    * {
    ...
    .image-box {
      background: rgba(255, 214, 225, 0.5);
      border-radius: 36px;
    ...
    <div class="products">
      <div class="card">
        <div class="image-box">
          ...
          <img src="https://pngimg.com/d/women_bag_PNG6410.png" alt="Bag 1">
        </div>
        <div class="product-name">Sabrina</div>
      ...
      <div class="card">
        <div class="image-box">
          <div class="eco-badge">♻ ECO</div>
          <img src="https://pngimg.com/d/women_bag_PNG6408.png" alt="Bag 2">
        </div>
        <div class="product-name">Brielle</div>
        <div class="bottom-row">
      ...
      <div class="card">
        <div class="image-box">
          <div class="eco-badge">♻ ECO</div>
          <img src="https://pngimg.com/d/women_bag_PNG6404.png" alt="Bag 3">
        </div>
        <div class="product-name">Naomi</div>
        <div class="bottom-row">
